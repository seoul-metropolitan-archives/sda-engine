    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'monCashSendingEnable', label: '월요일현송여부', width: 100, align: 'center', editor: 'text'},
                {key: 'tueCashSendingEnable', label: '화요일현송여부', width: 100, align: 'center', editor: 'text'},
                {key: 'wedCashSendingEnable', label: '수요일현송여부', width: 100, align: 'center', editor: 'text'},
                {key: 'thuCashSendingEnable', label: '목요일현송여부', width: 100, align: 'center', editor: 'text'},
                {key: 'friCashSendingEnable', label: '금요일현송여부', width: 100, align: 'center', editor: 'text'}
            ],
            body: {
                onClick: function () {
