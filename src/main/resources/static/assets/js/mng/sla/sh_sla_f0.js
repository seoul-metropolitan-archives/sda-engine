...
var ACTIONS = axboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        console.log(params);
        window.location = CONTEXT_PATH + "/api/v1//mng/sla/sh_sla_f0/download?" + params;
        return false;
    },
    PAGE_SAVE: function (caller, act, data) {
        ...
        if (caller.gridView01.validate()) {
            ...
            if (data === "save") {
                saveUrl = "/api/v1//mng/sla/sh_sla_f0";
            } else {
                saveUrl = "/api/v1//mng/sla/sh_sla_f0/writeSla";
            }
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'calleeGubun', label: '출동구분', width: 100, align: 'center'},
                {key: 'calleeResult', label: '결과', width: 100, align: 'center'},
                {key: 'calleeReqDatetime', label: '출동요청일시', width: 130, align: 'center'},
                {key: 'arrivalPlanDatetime', label: '도착예정일시', width: 130, align: 'center'},
                {key: 'handleDatetime', label: '완료일시', width: 130, align: 'center'},
                {key: 'recoverDatetime', label: '복구일시', width: 130, align: 'center'},
                {key: 'elapsedTime', label: '경과시간', width: 70, align: 'center'},
                {key: 'elapsedSeconds', label: '경과시간(초)', width: 80, align: 'center'},
