...
var ACTIONS = axboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        console.log(params);
        window.location = CONTEXT_PATH + "/api/v1//mng/sla/sh_sla_e0/download?" + params;
        return false;
    },
    PAGE_SAVE: function (caller, act, data) {
        ...
        if (caller.gridView01.validate()) {
            ...
            if (data === "save") {
                saveUrl = "/api/v1//mng/sla/sh_sla_e0";
            } else {
                saveUrl = "/api/v1//mng/sla/sh_sla_e0/writeSla";
            }
...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: 'stndDate', label: '기준월', width: 80, align: 'center'},
                ...
                {key: 'totalOperTime', label: '총운영시간', width: 100, align: 'center'},
                {key: 'realOperTime', label: '실제운영시간', width: 100, align: 'center'},
                {key: 'noneOperTime', label: '미운영시간', width: 100, align: 'center'}
            ],
            body: {
                onClick: function () {
