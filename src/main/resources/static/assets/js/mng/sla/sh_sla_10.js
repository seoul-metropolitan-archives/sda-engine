...
var ACTIONS = axboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        console.log(params);
        window.location = CONTEXT_PATH + "/api/v1//mng/sla/sh_sla_10/download?" + params;
        return false;
    },
    PAGE_SAVE: function (caller, act, data) {
        ...
        if (caller.gridView01.validate()) {
            ...
            if (data === "save") {
                saveUrl = "/api/v1//mng/sla/sh_sla_10";
            } else {
                saveUrl = "/api/v1//mng/sla/sh_sla_10/writeSla";
            }
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'calleeReqReason', label: '출동사유', width: 130, align: 'left'},
                ...
                {key: 'report', label: '처리내용', width: 130, align: 'left'},
                {
