...
var ACTIONS = axboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        console.log(params);
        window.location = CONTEXT_PATH + "/api/v1//mng/sla/sh_sla_b0/download?" + params;
        return false;
    },
    PAGE_SAVE: function (caller, act, data) {
        ...
        if (caller.gridView01.validate()) {
            ...
            if (data === "save") {
                saveUrl = "/api/v1//mng/sla/sh_sla_b0";
            } else {
                saveUrl = "/api/v1//mng/sla/sh_sla_b0/writeSla";
            }
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'totalCorp', label: '업체코드', width: 70, align: 'center'},
                {
                ...
                {key: 'mngGubun', label: '관리구분', width: 100, align: 'center'},
                {
                    key: 'operTimeGubun',
                    label: '운영구분',
                    width: 100,
                    ...
                    formatter: function formatter() {
                        ...
                        return operTimeGubun;
                    }
                },
                {key: 'terminalCorpName', label: '기기업체', width: 100, align: 'center'},
                {key: 'modelName', label: '기종', width: 130, align: 'left'},
                {key: 'atmGubun', label: 'ATM/CD구분', width: 100, align: 'center'},
                {key: 'overhaulDatetime', label: '점검일시', width: 130, align: 'center'}
            ],
            body: {
                onClick: function () {
