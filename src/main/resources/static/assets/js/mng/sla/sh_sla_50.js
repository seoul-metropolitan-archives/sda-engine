...
var ACTIONS = axboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        console.log(params);
        window.location = CONTEXT_PATH + "/api/v1//mng/sla/sh_sla_50/download?" + params;
        return false;
    },
    PAGE_SAVE: function (caller, act, data) {
        ...
        if (caller.gridView01.validate()) {
            ...
            if (data === "save") {
                saveUrl = "/api/v1//mng/sla/sh_sla_50";
            } else {
                saveUrl = "/api/v1//mng/sla/sh_sla_50/writeSla";
            }
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'txDatetime', label: '날짜', width: 100, align: 'center'},
                {key: 'ocmAmount', label: 'OCM산출금액', width: 200, align: 'right', formatter: "money"},
                {key: 'ocmAmount2', label: 'OCM산출금액(*1.8)', width: 200, align: 'right', formatter: "money"},
                {key: 'accountBalance', label: '업체잔고액', width: 200, align: 'right', formatter: "money"}
            ],
            body: {
                onClick: function () {
