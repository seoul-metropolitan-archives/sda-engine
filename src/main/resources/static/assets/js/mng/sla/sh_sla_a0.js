...
var ACTIONS = axboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        console.log(params);
        window.location = CONTEXT_PATH + "/api/v1//mng/sla/sh_sla_a0/download?" + params;
        return false;
    },
    PAGE_SAVE: function (caller, act, data) {
        ...
        if (caller.gridView01.validate()) {
            ...
            if (data === "save") {
                saveUrl = "/api/v1//mng/sla/sh_sla_a0";
            } else {
                saveUrl = "/api/v1//mng/sla/sh_sla_a0/writeSla";
            }
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'overhaulDate', label: '점검일', width: 100, align: 'center'},
                {key: 'cornerName', label: '코너명', width: 130, align: 'left'},
                {key: 'overhaulDate', label: '운영일', width: 80, align: 'center'},
                {key: 'branchGubun', label: '코너형태', width: 80, align: 'center'},
                {key: 'corpCode', label: '업체코드', width: 70, align: 'center'},
                {key: 'takePhotoEnable', label: '사진촬영유무', width: 80, align: 'center'},
                {key: 'successCount', label: '정상건수', width: 70, align: 'center'},
                {key: 'overhaulCount', label: '점검건수', width: 70, align: 'center'},
                {key: 'overhaulResult', label: '점검결과', width: 80, align: 'center'},
                {key: 'overhaulUnusl', label: '특이사항', width: 200, align: 'left'},
                {key: 'submitTargetCount', label: '제출대상건수', width: 80, align: 'center'},
                {key: 'submitCount', label: '제출건수', width: 70, align: 'center'},
                {key: 'productCondt', label: '상품안내장', width: 100, align: 'center'},
                {key: 'terminalCondt', label: '자동화기기', width: 100, align: 'center'},
                {key: 'groundCondt', label: '바닥', width: 100, align: 'center'},
                {key: 'garbageCondt', label: '휴지통', width: 100, align: 'center'},
                {key: 'cashEnvelopeCondt', label: '현금봉투', width: 100, align: 'center'},
                {key: 'posterCondt', label: '포스트', width: 100, align: 'center'}
            ],
            body: {
                onClick: function () {
