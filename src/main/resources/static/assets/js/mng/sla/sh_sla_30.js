...
var ACTIONS = axboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        console.log(params);
        window.location = CONTEXT_PATH + "/api/v1//mng/sla/sh_sla_30/download?" + params;
        return false;
    },
    PAGE_SAVE: function (caller, act, data) {
        ...
        if (caller.gridView01.validate()) {
            ...
            if (data === "save") {
                saveUrl = "/api/v1//mng/sla/sh_sla_30";
            } else {
                saveUrl = "/api/v1//mng/sla/sh_sla_30/writeSla";
            }
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'minwonDatetime', label: '민원발생일', width: 100, align: 'center'},
                {
                ...
                {key: 'regType', label: '등록구분', width: 70, align: 'center'},
                {
                    key: 'handleType',
                    label: '접수구분',
                    width: 140,
                ...
                {key: 'errorContent', label: '내용', width: 300, align: 'left'},
                {key: 'regDatetime', label: '등록일', width: 100, align: 'center'}
            ],
            body: {
                onClick: function () {
