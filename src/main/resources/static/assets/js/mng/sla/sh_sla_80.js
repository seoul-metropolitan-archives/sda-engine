...
var ACTIONS = axboot.actionExtend(fnObj, {
    ...
    EXCEL_DOWNLOAD: function (caller, act, data) {
        ...
        console.log(params);
        window.location = CONTEXT_PATH + "/api/v1//mng/sla/sh_sla_80/download?" + params;
        return false;
    },
    PAGE_SAVE: function (caller, act, data) {
        ...
        if (caller.gridView01.validate()) {
            ...
            if (data === "save") {
                saveUrl = "/api/v1//mng/sla/sh_sla_80";
            } else {
                saveUrl = "/api/v1//mng/sla/sh_sla_80/writeSla";
            }
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'calleeChasu', label: '출동차수', width: 80, align: 'center'},
                {
                    key: 'customerWait',
                    label: '고객대기',
                    width: 80,
                ...
                {key: 'corpCode', label: '업체코드', width: 80, align: 'center'},
                {key: 'calleeReqGubun', label: '출동형태', width: 80, align: 'center'},
                {
                ...
                {key: 'cornerCode', label: '코너코드', width: 80, align: 'center'},
