...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: 'stextNoticeDatetime', label: '전문통보일시', width: 100, align: 'center'},
                {key: 'stextGubun', label: '전문구분', width: 100, align: 'center'},
                {key: 'jisaCode', label: '지사코드', width: 100, align: 'center'},
                {key: 'branchCode', label: '지점코드', width: 100, align: 'center'},
                {key: 'cornerCode', label: '코너코드', width: 100, align: 'center'},
