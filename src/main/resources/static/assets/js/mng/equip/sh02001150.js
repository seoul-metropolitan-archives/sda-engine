    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: 'terminalSeqNo', label: '기기일련번호', width: 100, align: 'left', editor: 'text'},
                ...
                {key: 'terminalNo', label: '기기번호', width: 100, align: 'left', editor: 'text'},
                {key: 'terminalCorpCode', label: '기기업체코드', width: 100, align: 'left', editor: 'text'},
                {key: 'modelCode', label: '기종코드', width: 100, align: 'left', editor: 'text'},
                {key: 'terminalProdNo', label: '기기제조번호', width: 100, align: 'left', editor: 'text'},
