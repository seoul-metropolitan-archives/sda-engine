...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: 'changeBeforeAssetSeqNo', label: '변경전자산일련번호', width: 150, align: 'left', editor: 'text'},
                {key: 'changeAfterAssetSeqNo', label: '변경후자산일련버호', width: 150, align: 'left', editor: 'text'},
                ...
                {key: 'changeDatetime', label: '변경일자', width: 100, align: 'left', editor: 'text'}
            ],
            body: {
                onClick: function () {
