...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: 'containerUuid', label: 'CONTAINER_UUID', width: 100, align: 'left', editor: 'text'},{key: 'statusUuid', label: 'STATUS_UUID', width: 100, align: 'left', editor: 'text'},{key: 'containerName', label: 'CONTAINER_NAME', width: 100, align: 'left', editor: 'text'},{key: 'containerTypeUuid', label: 'CONTAINER_TYPE_UUID', width: 100, align: 'left', editor: 'text'},{key: 'controlNumber', label: 'CONTROL_NUMBER', width: 100, align: 'left', editor: 'text'},{key: 'provenance', label: 'PROVENANCE', width: 100, align: 'left', editor: 'text'},{key: 'creationStartDate', label: 'CREATION_START_DATE', width: 100, align: 'left', editor: 'text'},{key: 'creationEndDate', label: 'CREATION_END_DATE', width: 100, align: 'left', editor: 'text'},{key: 'orderNo', label: 'ORDER_NO', width: 100, align: 'left', editor: 'text'},{key: 'orderKey', label: 'ORDER_KEY', width: 100, align: 'left', editor: 'text'},{key: 'description', label: 'DESCRIPTION', width: 100, align: 'left', editor: 'text'},{key: 'notes', label: 'NOTES', width: 100, align: 'left', editor: 'text'},{key: 'useYn', label: 'USE_YN', width: 100, align: 'left', editor: 'text'},{key: 'insertUuid', label: 'INSERT_UUID', width: 100, align: 'left', editor: 'text'},{key: 'insertDate', label: 'INSERT_DATE', width: 100, align: 'left', editor: 'text'},{key: 'updateUuid', label: 'UPDATE_UUID', width: 100, align: 'left', editor: 'text'},{key: 'updateDate', label: 'UPDATE_DATE', width: 100, align: 'left', editor: 'text'}
            ],
            body: {
                onClick: function () {
