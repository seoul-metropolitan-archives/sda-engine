...
fnObj.pageStart = function () {
    ...
    axboot
        .call({
            type: "GET", url: "/api/v1/common-code", data: {groupCd: "USER_ROLE", useYn: "Y"},
            callback: function (res) {
                var userRole = [];
        ...
        validateSelectedFiles: function () {
            ...
            if ($("#key").val() == '') {
                axDialog.alert({
                    ...
                    theme: "default",
                    msg: 'key를 입력한 후에 이미지를 선택하세요.'
                });
                return false;
            }

            this.self.config.form.key = $("#key").val();
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "etc3", label: "ETC3", width: 90, align: "center",
                    formatter: function () {
                        //console.log('formatter: ', this);
                        var className = 'error_status error_status-success';

                        if (this.value == 'N') {
                            className = 'error_status error_status-danger';
                        }

                        var result = "<div class='" + className + "'><span>SH-1000-1011</span></div>";
                        /*var result = "<div class='" + className + "'><i class='cqc-tag2'></i>&nbsp;" +
                            "<span>SH-1000-1011</span></div>";*/
