...
fnObj.pageStart = function () {
    ...
    axboot
        .call({
            type: "GET", url: "/api/v1/program", data: {showAll: "Y"},
            callback: function (res) {
                var programList = [];
                res.list.forEach(function (n) {
                    programList.push({
        ...
        .call({
            type: "GET", url: "/api/v1/common-code", data: {groupCd: "AUTH_GROUP", useYn: "Y"},
            callback: function (res) {
                var authGroup = [];
                res.list.forEach(function (n) {
                    authGroup.push({
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                ...
                {key: "useYn", label: "접근권한", editor: "checkYn"},
                ...
                {key: "fn1Ah", label: "화면갱신", width: 80, align: "center", editor: "menu-program-auth-checkYn"},
                {key: "fn2Ah", label: "페이지+모델 작성", width: 130, align: "center", editor: "menu-program-auth-checkYn"},
