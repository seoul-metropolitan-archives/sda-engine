    ...
    */
    ...
    var columns = [
				...
				},
        {
            ...
            values: ["분류체계 유형", "Aggreation 계층", "아이템 유형", "컴퍼넌트 유형"],
            labels: ["분류체계 유형", "Aggreation 계층", "아이템 유형", "컴퍼넌트 유형"],
            editor: {
                type: "dropDown",
                dropDownCount: 10,
				...
				},
        {
            ...
            editable: true,
            lookupDisplay: true, //라벨로 표시
            values: ["추가메타1", "추가메타2", "추가메타3"],
            labels: ["추가메타1", "추가메타2", "추가메타3"],
            editor: {
                type: "dropDown",
                dropDownCount: 10,
                domainOnly: true, //domainOnly가 true이면 목록에 있는 값들만 선택할 수 있습니다.
    ...
    var data = [
        ["Confirm", "분류체계 유형", "기능분류", "분류체계 맥락", "추가메타1","콤보","CD001","타이틀1","false","false","설명", "노트", "true", "등록자", "2017-04-17 01:02:03", "수정자", "2017-04-17 01:02:03"],
        ["Save", "Aggreation 계층", "주제분류", "Aggreation 맥락", "추가메타2","팝업","PU001","Record명","false","false","설명", "노트", "true", "등록자", "2017-04-17 01:02:03", "수정자", "2017-04-17 01:02:03"],
        ["Confirm", "아이템 유형", "Seriese", "아이템 맥락", "추가메타1","콤보","CD004","시기","false","false","설명", "노트", "true", "등록자", "2017-04-17 01:02:03", "수정자", "2017-04-17 01:02:03"],
        ["Confirm", "컴퍼넌트 유형", "문서관리", "컴퍼넌트 맥락", "추가메타3","텍스트","CD001","용량","false","false","설명", "노트", "true", "등록자", "2017-04-17 01:02:03", "수정자", "2017-04-17 01:02:03"],
