...
*/
    ...
    var columns = [
				...
				},
        {
            ...
            sortable: true,
            lookupDisplay: true, //라벨로 표시
            values: ["사용자", "시스템관리자", "DB관리자", "관리자"],
            labels: ["사용자", "시스템관리자", "DB관리자", "관리자"],
            editor: {
                type: "dropDown",
                dropDownCount: 10,
                domainOnly: true, //domainOnly가 true이면 목록에 있는 값들만 선택할 수 있습니다.
				...
				},
        {
            ...
            sortable: true,
            lookupDisplay: true, //라벨로 표시
            values: ["", "코드", "코드명", "정렬순서", "관리자"],
            labels: ["", "코드", "코드명", "정렬순서", "관리자"],
            editor: {
                type: "dropDown",
                dropDownCount: 10,
                domainOnly: true, //domainOnly가 true이면 목록에 있는 값들만 선택할 수 있습니다.
    ...
    var data = [
				["AA001", "코드유형", "Service1", "시스템", "정렬방법", "설명", "노트",  "false","", "", "", "", "", "", "", "", "", "", "등록자", "2017-04-17 01:02:03", "수정자", "2017-04-17 01:02:03"],
				["AA002", "정렬방법", "Service1", "시스템", "정렬방법", "설명", "노트", "false", "", "", "", "", "", "", "", "", "", "", "등록자", "2017-04-17 01:02:03", "수정자", "2017-04-17 01:02:03"],
                ["AA003", "정렬방법", "Service1", "시스템", "정렬방법",  "설명", "노트","false", "", "", "", "", "", "", "", "", "", "", "등록자", "2017-04-17 01:02:03", "수정자", "2017-04-17 01:02:03"],
			];
