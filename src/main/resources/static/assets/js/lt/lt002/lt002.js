...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    ...
    initView: function () {
        ...
        this.target = axboot.gridBuilder({
            ...
            columns: [
                {key: 'softwareUuid', label: 'SOFTWARE_UUID', width: 100, align: 'left', editor: 'text'},{key: 'softwareName', label: 'SOFTWARE_NAME', width: 100, align: 'left', editor: 'text'},{key: 'softwareVersion', label: 'SOFTWARE_VERSION', width: 100, align: 'left', editor: 'text'},{key: 'vendorName', label: 'VENDOR_NAME', width: 100, align: 'left', editor: 'text'},{key: 'vendorHomepage', label: 'VENDOR_HOMEPAGE', width: 100, align: 'left', editor: 'text'},{key: 'licenseCode', label: 'LICENSE_CODE', width: 100, align: 'left', editor: 'text'},{key: 'installPath', label: 'INSTALL_PATH', width: 100, align: 'left', editor: 'text'},{key: 'exeFileName', label: 'EXE_FILE_NAME', width: 100, align: 'left', editor: 'text'},{key: 'description', label: 'DESCRIPTION', width: 100, align: 'left', editor: 'text'},{key: 'notes', label: 'NOTES', width: 100, align: 'left', editor: 'text'},{key: 'useYn', label: 'USE_YN', width: 100, align: 'left', editor: 'text'},{key: 'insertUuid', label: 'INSERT_UUID', width: 100, align: 'left', editor: 'text'},{key: 'insertDate', label: 'INSERT_DATE', width: 100, align: 'left', editor: 'text'},{key: 'updateUuid', label: 'UPDATE_UUID', width: 100, align: 'left', editor: 'text'},{key: 'updateDate', label: 'UPDATE_DATE', width: 100, align: 'left', editor: 'text'}
            ],
            body: {
                onClick: function () {
