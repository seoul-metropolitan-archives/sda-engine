package com.bgf.shbank.controller.api.mng.etc.sh04001190;
...
public class Sh04001190Controller extends BaseController {
    ...
    @GetMapping("/download")
    public View download(RequestParams<Sh04001190VO> requestParams, Model model) {

        List<Sh04001190> resultList = sh04001190Service.find(requestParams);

        List<Sh04001190VO> voList = Sh04001190VO.of(resultList);

        Map<String, Object> params = Maps.newHashMap();
        params.put("vo", voList);

        model.addAttribute("vo", voList);
        model.addAttribute("txId", "Sh04001190");
        model.addAttribute("fileName", "관리자메시지-" + DateUtils.getNow("yyyyMMdd_HHmmss"));
