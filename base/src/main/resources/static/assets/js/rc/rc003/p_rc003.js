...
fnObj.formView = axboot.viewExtend(axboot.formView, {
        ...
        $("#doAggregation,#doItem,#edit,#move,#updateStatus,#delete").click(function(e){
            ...
            switch(e.currentTarget.id)
            {
                case "doAggregation":
                    ...
                    fnObj.formView.openPopup("AGGREGATION_ADD", "Add Aggregation", sendData);
                    break;
                case "doItem":
                    sendData = $.extend({},{
                    ...
                    fnObj.formView.openPopup("ITEM_ADD", "Add Item", sendData);
                    break;
                case "edit":
                    sendData = $.extend({},{
    ...
    openPopup: function(type, title, sendData, callback) {
        if(!callback){
            callback = function (data) {
