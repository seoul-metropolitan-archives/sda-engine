...
var ACTIONS = axboot.actionExtend(fnObj, {
    PAGE_SEARCH: function (caller, act, data) {
        axboot.ajax({
            type: "POST",
            url: "/api/v1/ad/ad000/getEnviromentList.do",
...
var fnObj = {
    pageStart: function () {
        var _this = this;
        $.ajax({
            url: "/assets/js/column_info/ad00001.js",
            dataType: "script",
            async: false,
            success: function () {
            }
...
fnObj.gridView01 = axboot.viewExtend(axboot.gridView, {
    tagId: "realgrid01",
    primaryKey : "serviceUuid",
    entityName: "AD_SERVICE",
    initView: function () {
        this.initInstance();
        this.setColumnInfo(ad00001.column_info);
