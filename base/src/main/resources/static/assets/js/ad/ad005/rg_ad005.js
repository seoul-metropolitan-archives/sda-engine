...
/*    gridView.setFixedOptions({
    ...
    var fields = [
        ...
        {
            fieldName: "field8",dataType: "datetime"
        },
        {
            fieldName: "field9"
        },
       ...
       
{
    ...
    var data = [
				["freeze", "동결", "varchar2", "처분일정에 대한 동결처리", "Notes",  "false","등록자", "2017-04-17 01:02:03", "수정자", "2017-04-17 01:02:03"],
        ["item", "아이템", "varchar2", "조직이나 사람이 법적 의무나 사업 거래를 통해 증거와 정보로 생성, 접수, 유지하는 정보", "Notes",  "false","등록자", "2017-04-17 01:02:03", "수정자", "2017-04-17 01:02:03"],
        ["component", "컴포넌트", "varchar2", "처분일정에 대한 동결처리", "Notes",  "false","등록자", "2017-04-17 01:02:03", "수정자", "2017-04-17 01:02:03"],
